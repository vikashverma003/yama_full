          ...
          <div class="card">
            <div class="card-body">
               @foreach($errors->all() as $error)
                  ...
                  @endif
                <a href="{{url('admin/addServices')}}" class="btn addLangBtn">
                  Add Services
                          </a>
                     ...
                     <table id="order-listing" class="table">
                      ...
                      <tbody>
                        ...
                        <tr>
                            ...
                            <td><img src="{{$lag->image}}" alt="image"></td>
                            <td><label class="badge">{{$lag->question}}</label></td>
                            <td><label class="badge">{{$lag->answer}}</label></td>
                            <td>
                              <ul class="navbar-nav">
                                <li class="nav-item dropdown d-none d-lg-flex">
                                  ...
                                  <div class="dropdown-menu navbar-dropdown" aria-labelledby="actionDropdown">
                                    ...
                                    <a href="{{route('editServices',$lag->id)}}" class="dropdown-item" >Edit</a>
   ...
   function delete_confirmation(id)
  {
    ...
    .then((willDelete) => {
      if (willDelete) {
        ...
        $.ajax({
          type: 'GET',
          url: "{{route('delete_services')}}?user_id="+id,
