                ...
                <div class="order-menu">
                    <div class="menu-category">
                        ...
                        <ul class="nav navbar-nav">
                           ...
                           <!-- <li  class="{{ (strpos(Route::currentRouteName(), 'food_ordering.category_item') == 0) ? 'active' : '' }}" >-->
                           <li  class="{{ (request()->is('admin/food_ordering/category_item/'.$food_group['category_id'])) ? 'active' : '' }}" >
                            <a  href="{{url('admin/food_ordering/category_item')}}/{{$food_group['category_id']}}">
