                     ...
                     <table id="order-listing" class="table">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><img src="{{$url}}/{{$user->profile_image}}" alt="image" /></td>
                          @php }else{ @endphp
                           ...
                           <td>{{$user->random}}</td>
                            ...
                            <!-- <td>
                                <label class="badge {{$user->block_status == '0' ? 'badge-success' : 'badge-danger'}}"> {{$user->approved_status == '0' ? 'Unapproved' : 'approved'}}</label>
                            </td> -->
                            <td>{{$user->name}}</td>
                                ...
                                <li class="nav-item dropdown d-none d-lg-flex">
                                  <a class="nav-link  nav-btn" id="actionDropdown" href="#" data-toggle="dropdown">
                                   ...
                                   <div class="dropdown-menu navbar-dropdown" aria-labelledby="actionDropdown">
                                     <a href="{{route('viewDoctor',$user->id)}}" class="dropdown-item" >View</a>
                                    <!--  <a href="{{route('EditDoctor',$user->id)}}" class="dropdown-item" >Edit</a> -->
                                   ...
                                   <!--  @if($user->approved_status == '0')
                                      <a href="#" class="dropdown-item" onclick="approved_confirmation('{{$user->id}}','approved')">Approved</a>
                                    @else
                                    <a href="#" class="dropdown-item" onclick="approved_confirmation('{{$user->id}}','Unapproved')"> UnApproved</a>
                                    @endif -->
