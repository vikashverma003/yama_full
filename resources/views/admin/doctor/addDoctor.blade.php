                    ...
                    <div class="card-body">
                      <form class="forms-sample" action="{{url('admin/addDoctor')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="gnprofessional_card" id="exampleInputEmail1" placeholder="Enter Professional Id" >
                        </div>
                        <div class="form-group">
                      ...
                      <span id="title_Professional" style="color: red;"></span>
                         ...
                         <div class="form-group">
                          ...
                          <input type="text" name="curp" class="form-control" id="exampleInputPassword1" placeholder="Enter Curp" >
                        </div>
                      ...
                      <span id="curp_doc" style="color: red;"></span>
                         ...
                         <div class="form-group">
                          ...
                          <input type="text" name="rfc" class="form-control" id="exampleInputPassword1" placeholder="Enter RFC" >
                        </div>

                         <div class="form-group">
                      <label>Address</label>
                      <input type="text" name="proof_address" class="form-control" id="exampleInputPassword1" placeholder="Enter Address" >
                    </div>
                ...
                <div class="col-6 grid-margin">
                  <div class="card">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="ssa_registration" class="form-control" id="exampleInputPassword1" placeholder="Enter S.S.A. Registration" >
                    </div>
                    ...
                    <div class="form-group">
                          ...
                          <input type="text" name="phone_number" class="form-control" id="exampleInputPassword1" placeholder="Enter Telephone" >
                        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                          ...
                          <input type="text" name="municipality" class="form-control" id="exampleInputEmail1" placeholder="Enter Municipality" >
                        </div>
                        <div class="form-group">
                         ...
                         <div class="form-group">
                          ...
                          <input type="text" name="country" class="form-control" id="exampleInputEmail1" placeholder="Enter Country" >
                        </div>

                        
                         <div class="form-group">
                          <label for="exampleInputPassword1">Email</label>
                          <input type="email" name="mail" class="form-control" id="exampleInputPassword1" placeholder="Enter Email" >
                        </div>
                  ...
                  <div class="card">
                    <div class="card-body">
                       ...
                       <div class="form-group">
                          ...
                          <input type="text" name="name_rfc" class="form-control" id="exampleInputEmail1" placeholder="Enter Name or RFC " >
                        </div>

                       <div class="form-group">
                          <label for="exampleInputEmail1">Number</label>
                          <input type="text" name="number" class="form-control" id="exampleInputEmail1" placeholder="Enter Number " >
                        </div>

                          <div class="form-group">
                          <label for="exampleInputEmail1">Colonia</label>
                          <input type="text" name="colonia" class="form-control" id="exampleInputEmail1" placeholder="Enter Colonia " >
                        </div>
                        <div class="form-group">
                          <label for="exampleInputPassword1">Postal code</label>
                          <input type="text" name="zipcode" class="form-control" id="exampleInputPassword1" placeholder="Postal code" >
                        </div>
                  ...
                  <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" name="purchase_goods" class="form-control" id="exampleInputEmail1" placeholder="Enter Acquisition of merchandise" >
                        </div>

                         <div class="form-group">
                          <label for="exampleInputEmail1">General expenses</label>
                          <input type="text" name="accessories" class="form-control" id="exampleInputEmail1" placeholder="Enter General expenses" >
                        </div>

                         <div class="form-group">
                          <label for="exampleInputEmail1">Telephone communications</label>
                          <input type="text" name="telephone_communications" class="form-control" id="exampleInputEmail1" placeholder="Enter Telephone communications" >
                        </div>

                         <div class="form-group">
                          <label for="exampleInputPassword1">Medical, dental and hospital fees</label>
                          <input type="text" name="hospital_fees" class="form-control" id="exampleInputPassword1" placeholder="Enter Medical, dental and hospital fees" >
                        </div>
                         <div class="form-group">
                          <label for="exampleInputPassword1">Medical expense insurance premiums</label>
                          <input type="text" name="insurance_premiums" class="form-control" id="exampleInputPassword1" placeholder="Enter Medical expense insurance premiums" >
                        </div>

                        <div class="form-group">
                          <label for="exampleInputPassword1">Payments for educational services (tuition)</label>
                          <input type="text" name="educational_services" class="form-control" id="exampleInputPassword1" placeholder="Enter Payments for educational services" >
                        </div>
                  ...
                  <div class="card">
                    <div class="card-body">
                       ...
                       <div class="form-group">
                          ...
                          <input type="text" name="returns" class="form-control" id="exampleInputEmail1" placeholder="Enter Returns, discounts" >
                        </div>

                       <div class="form-group">
                          <label for="exampleInputEmail1">Computer equipment and accessories</label>
                          <input type="text" name="accessories" class="form-control" id="exampleInputEmail1" placeholder="Enter >Computer equipment " >
                        </div>

                     <div class="form-group">
                          <label for="exampleInputEmail1">Comunicaciones satelitales</label>
                          <input type="text" name="satellite_communications" class="form-control" id="exampleInputEmail1" placeholder="Enter Comunicaciones satelitales " >
                        </div>


                    <div class="form-group">
                          <label for="exampleInputEmail1">Medical expenses for disability or disability</label>
                          <input type="text" name="medical_expenses" class="form-control" id="exampleInputEmail1" placeholder="Enter disability" >
                        </div>

                        <div class="form-group">
                          <label for="exampleInputEmail1">To be defined</label>
                          <input type="text" name="be_defined" class="form-control" id="exampleInputEmail1" placeholder="Enter To be defined" >
                        </div>
              ...
              <div class="row flex-grow">
                <div class="col-6 grid-margin">
                  <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" name="bank_account" class="form-control" id="exampleInputEmail1" placeholder="Enter Bank account" >
                        </div>
                  ...
                  <div class="form-group">
                          ...
                          <input type="text" name="rfc" class="form-control" id="exampleInputEmail1" placeholder="Enter RFC" >
                        </div>

                   <div class="form-group">
                          <label for="exampleInputEmail1">Bank name</label>
                          <input type="text" name="bank_name" class="form-control" id="exampleInputEmail1" placeholder="Enter Bank name" >
                        </div>
                  ...
                  <div class="card">
                   ...
                   <span id="account_new_type"></span>
                    ...
                    <label for="exampleSelectSuccess">Account type</label>
                     <input type="text" name="type_account" class="form-control" id="exampleInputEmail1" placeholder="Enter Account type" >
                  </div>

                <div class="form-group">
                          <label for="exampleInputEmail1">Interbank key</label>
                          <input type="text" name="interbank_type" class="form-control" id="exampleInputEmail1" placeholder="Enter Interbank key" >
                        </div>
                  ...
                  <div class="card">
                    <div class="card-body">
                        <div class="form-group">
                          ...
                          <input type="text" name="chatfullname" class="form-control" id="exampleInputEmail1" placeholder="Enter Full name" >
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <input type="number" name="chatexperience" class="form-control" id="exampleInputEmail1" placeholder="Enter experience" >
                        </div>
                      ...
                      <div class="form-group">
                          ...
                          <input type="text" name="chatworkplace" class="form-control" id="exampleInputEmail1" placeholder="Enter Workplace" >
                      </div>
                  ...
                  <div class="card">
                    <div class="card-body">
                      ...
                      <div class="form-group">
                          ...
                          <input type="text" name="chatprofessional_card" class="form-control" id="exampleInputEmail1" placeholder="Enter Professional card" >
                        </div>

                     <div class="form-group">
                          <label for="exampleInputEmail1">Short personal description</label>
                          <input type="text" name="chatshort_description" class="form-control" id="exampleInputEmail1" placeholder="Enter personal description" >
                        </div>

                 <div class="form-group">
                          <label for="exampleInputEmail1">Degrees</label>
                          <input type="text" name="chatdegrees" class="form-control" id="exampleInputEmail1" placeholder="Enter Degrees" >
                        </div>
                ...
                <div class="col-6 grid-margin">
                  <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                          <label for="exampleInputEmail1">Years of experience</label>
                          <input type="number" class="form-control" id="exampleInputEmail1" name="experience" placeholder="Enter experience" >
                        </div>
                         
                       <div class="form-group">
                          <label for="exampleInputEmail1">Bachelor's degree and name of the university</label>
                          <input type="text" name="b_degree" class="form-control" id="exampleInputEmail1" placeholder="Enter Bachelor's degree and name of the university" >
                      </div>

                      <div class="form-group">
                          <label for="exampleInputEmail1">Medical speciality and name of the university</label>
                          <input type="text" name="m_speciality" class="form-control" id="exampleInputEmail1" placeholder="Enter Medical speciality and name of the university" >
                      </div>
                      ...
                      <div class="form-group">
                          ...
                          <input type="text" name="s_medical_speciality" class="form-control" id="exampleInputEmail1" placeholder="Enter Sub medical speciality and name of the university" >
                      </div>

                      <div class="form-group">
                          <label for="exampleInputEmail1">Master and name of the university</label>
                          <input type="text" name="master_name" class="form-control" id="exampleInputEmail1" placeholder="Enter Master and name of the university" >
                      </div>

                      <div class="form-group">
                          <label for="exampleInputEmail1">PhD and name of the university</label>
                          <input type="text" name="phd_name" class="form-control" id="exampleInputEmail1" placeholder="Enter PhD and name of the university" >
                      </div>

                      <div class="form-group">
                          <label for="exampleInputEmail1">Address</label>
                          <input type="text" name="address" class="form-control" id="txtPlace" placeholder="Enter address" >
                      </div>
                      ...
                      <div class="form-group">
                          <label for="exampleInputEmail1">State</label>
                          <input type="text" name="state" class="form-control" id="txtState" placeholder="Enter State" >
                      </div>

                      <div class="form-group">
                          <label for="exampleInputEmail1">Postal code</label>
                          <input type="text" name="zipcode" class="form-control" id="txtZip" placeholder="Enter Postal code" >
                      </div>
                      ...
                      <div class="form-group">
                          ...
                          <input type="text" name="awards" class="form-control" id="exampleInputEmail1" placeholder="Enter Awards" >
                      </div>

                      <div class="form-group">
                          <label for="exampleInputEmail1">Courses</label>
                          <input type="text" name="courses" class="form-control" id="exampleInputEmail1" placeholder="Enter Courses" >
                      </div>
                ...
                <div class="col-6 grid-margin">
                  <div class="card">
                    <div class="card-body">
                      <div class="form-group">
                          <label for="exampleInputEmail1">Professional card</label>
                          <input type="text" name="proprofessional_card" class="form-control" id="exampleInputEmail1" placeholder="Enter Professional card" >
                        </div>

                  <div class="form-group">
                          <label for="exampleInputEmail1">Short personal description</label>
                          <input type="text" name="short_description" class="form-control" id="exampleInputEmail1" placeholder="Enter personal description" >
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                          <label for="exampleInputEmail1">Country</label>
                          <input type="text" name="country" class="form-control" id="txtCountry" placeholder="Enter Country" >
                        </div>

                        <div class="form-group">
                          <label for="exampleInputEmail1">Recognition</label>
                          <input type="text" name="recognition" class="form-control" id="exampleInputEmail1" placeholder="Enter Recognition" >
                        </div>

                        <div class="form-group">
                          <label for="exampleInputEmail1">Days of attention</label>
                          <input type="text" name="day" class="form-control" id="exampleInputEmail1" placeholder="Enter Days of attention" >
                        </div>

                        <div class="form-group">
                          <label for="exampleInputEmail1">Hours of attention</label>
                          <input type="text" name="hours" class="form-control" id="exampleInputEmail1" placeholder="Enter Hours of attention" >
                        </div> 

                        <div class="form-group">
                          <label for="exampleInputEmail1">Contact number</label>
                          <input type="text" name="contact_number" class="form-control" id="exampleInputEmail1" placeholder="Enter Contact number" >
                        </div> 
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-check form-check-flat">
                            <label class="form-check-label">
                               <input type="radio" id="registration" name="pre_registration" value="completed" >
                              Completed
                            <i class="input-helper"></i></label>
                          </div>
                          <div class="form-check form-check-flat">
                            <label class="form-check-label">
                               <input type="radio" id="registration" name="pre_registration" value="pending" >
                              Pending
                            <i class="input-helper"></i></label>
                          </div>
                           ...
                           <div class="form-check form-check-flat">
                            <label class="form-check-label">
                               <input type="radio" id="registration" name="pre_registration" value="rejected" >
                              Rejected
                            <i class="input-helper"></i></label>
                          </div>
                        </div>
                  ...
                  <div class="card">
                    <div class="card-body">
                        <div class="form-group">
                         ...
                         <div class="form-check form-check-flat">
                            <label class="form-check-label">
                               <input type="radio" id="Presentation" name="presentation" value="completed" >
                              Completed
                            <i class="input-helper"></i></label>
                          </div>
                          ...
                          <div class="form-check form-check-flat">
                            <label class="form-check-label">
                               <input type="radio" id="Presentation" name="presentation" value="pending" >
                              Pending
                            <i class="input-helper"></i></label>
                          </div>
                           ...
                           <div class="form-check form-check-flat">
                            <label class="form-check-label">
                               <input type="radio" id="Presentation" name="presentation" value="rejected" >
                              Rejected
                            <i class="input-helper"></i></label>
                          </div>
                        </div>
                  ...
                  <div class="card">
                    <div class="card-body">
                        <div class="form-group">
                         ...
                         <div class="form-check form-check-flat">
                            <label class="form-check-label">
                               <input type="radio" id="Interview" name="interview" value="completed" >
                              Completed
                            <i class="input-helper"></i></label>
                          </div>
                          <div class="form-check form-check-flat">
                            <label class="form-check-label">
                               <input type="radio" id="Interview" name="interview" value="pending" >
                              Pending
                            <i class="input-helper"></i></label>
                          </div>
                           <div class="form-check form-check-flat">
                            <label class="form-check-label">
                               <input type="radio" id="Interview" name="interview" value="rejected" >
                              Rejected
                            <i class="input-helper"></i></label>
                          </div>
                        </div>
                  ...
                  <div class="card">
                    <div class="card-body">
                        <div class="form-group">
                         ...
                         <div class="form-check form-check-flat">
                            <label class="form-check-label">
                               <input type="radio" id="contract" name="contract" value="completed" >
                              Completed
                            <i class="input-helper"></i></label>
                          </div>
                          <div class="form-check form-check-flat">
                            <label class="form-check-label">
                               <input type="radio" id="contract" name="contract" value="pending" >
                              Pending
                            <i class="input-helper"></i></label>
                          </div>
                           <div class="form-check form-check-flat">
                            <label class="form-check-label">
                               <input type="radio" id="contract" name="contract" value="rejected" >
                              Rejected
                            <i class="input-helper"></i></label>
                          </div>
                        </div>
                  ...
                  <div class="card">
                    <div class="card-body">
                        <div class="form-group">
                         ...
                         <div class="form-check form-check-flat">
                            <label class="form-check-label">
                               <input type="radio" id="Photo" name="photo_registration" value="completed" >
                              Completed
                            <i class="input-helper"></i></label>
                          </div>
                          ...
                          <div class="form-check form-check-flat">
                            <label class="form-check-label">
                               <input type="radio" id="Photo" name="photo_registration" value="pending" >
                              Pending
                            <i class="input-helper"></i></label>
                          </div>
                           <div class="form-check form-check-flat">
                            <label class="form-check-label">
                               <input type="radio" id="Photo" name="photo_registration" value="rejected" >
                              Rejected
                            <i class="input-helper"></i></label>
                          </div>
                        </div>
                  ...
                  <div class="card">
                    <div class="card-body">
                        <div class="form-group">
                         ...
                         <div class="form-check form-check-flat">
                            <label class="form-check-label">
                               <input type="radio" id="Activation" name="activation" value="completed" >
                              Completed
                            <i class="input-helper"></i></label>
                          </div>
                          <div class="form-check form-check-flat">
                            <label class="form-check-label">
                               <input type="radio" id="Activation" name="activation" value="pending" >
                              Pending
                            <i class="input-helper"></i></label>
                          </div>
                           <div class="form-check form-check-flat">
                            <label class="form-check-label">
                               <input type="radio" id="Activation" name="activation" value="rejected" >
                              Rejected
                            <i class="input-helper"></i></label>
                          </div>
                        </div>
                  ...
                  <div class="card">
                    <div class="card-body">
                        <div class="form-group">
                         ...
                         <div class="form-check form-check-flat">
                            <label class="form-check-label">
                               <input type="radio" id="Activation" name="document_registration" value="completed" >
                              Completed
                            <i class="input-helper"></i></label>
                          </div>
                          <div class="form-check form-check-flat">
                            <label class="form-check-label">
                               <input type="radio" id="Activation" name="document_registration" value="pending" >
                              Pending
                            <i class="input-helper"></i></label>
                          </div>
                           <div class="form-check form-check-flat">
                            <label class="form-check-label">
                               <input type="radio" id="Activation" name="document_registration" value="rejected" >
                              Rejected
                            <i class="input-helper"></i></label>
                          </div>
                        </div>
